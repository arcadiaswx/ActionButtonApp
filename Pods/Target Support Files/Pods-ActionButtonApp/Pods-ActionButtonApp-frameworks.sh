...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ActionButtonApp/FBSDKLoginKit.framework"
  install_framework "Pods-ActionButtonApp/FormatterKit.framework"
  install_framework "Pods-ActionButtonApp/IOStickyHeader.framework"
  install_framework "Pods-ActionButtonApp/MBProgressHUD.framework"
  install_framework "Pods-ActionButtonApp/Parse.framework"
  install_framework "Pods-ActionButtonApp/ParseFacebookUtilsV4.framework"
